...
void dijkstra(dungeon_t *d)
{
  ...
  d->pc_distance[character_get_y( (const character *) d->PC)][character_get_x( (const character *) d->PC)] = 0;
...
void dijkstra_tunnel(dungeon_t *d)
{
  ...
  d->pc_tunnel[character_get_y((const character *)d->PC)][character_get_x((const character *)d->PC)] = 0;
